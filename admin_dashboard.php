...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="wppw_idth=device-wppw_idth, initial-scale=1.0">
...
<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom" style="background-color: #f5f5f5;">
    ...
    <ul class="nav nav-pills">
                    ...
                    <div class="row d-block d-sm-block d-md-none">
                      <?php foreach ($rows as $row) { ?>
                        <div class="col-md-6">
                            <div class="card mb-3">
                              <div class="card-body">
                                <h5 class="card-title"><?php echo $row['u_ppw_id']; ?></h5>
        ...
        <div class="modal fade" ppw_id="modal1" tabindex="-1" aria-labelledby="modal1Title" aria-hppw_idden="true">
        ...
        <?php foreach ($rows as $row) { ?>
            <div class="modal fade" ppw_id="patientModal<?php echo $row['u_ppw_id']; ?>" tabindex="-1" aria-labelledby="patientModalLabel<?php echo $row['p_ppw_id']; ?>" aria-hppw_idden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" ppw_id="patientModalLabel<?php echo $row['u_ppw_id']; ?>">Your Details</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <p><b>Your ppw_id:</b> <?php echo $row['u_ppw_id']; ?></p>
